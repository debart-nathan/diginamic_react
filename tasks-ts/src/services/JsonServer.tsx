...
export default class JsonServer {
    ...
    static async addRemoteTask(task:Omit<TaskInterface,"id">):Promise<TaskInterface>{
        return fetch(`${JsonServer.url}`,{
            headers:{
                'Accept':"application/json",
            'Content-Type': 'application/json'
    ...
    static async patchRemoteTaskDone(task_id:number,done:boolean):Promise<TaskInterface>{
        return fetch(`${JsonServer.url}/${task_id}`,{
            headers:{
                'Accept':"application/json",
            'Content-Type': 'application/json'
